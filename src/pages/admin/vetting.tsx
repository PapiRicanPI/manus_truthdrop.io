  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        <div className="note">
          <p>Vetting application management is being rebuilt into this platform. In the meantime, applications submitted via <strong>vet.thevault.watch</strong> can be reviewed there.</p>
          <p style={{ marginTop: "1rem" }}>Full vetting workflow (approve/reject with email notifications) will be available in the next update.</p>
        </div>
      </div>
    </>
  );
